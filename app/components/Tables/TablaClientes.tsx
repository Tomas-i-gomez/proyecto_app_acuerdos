...
const ClientTable = () => {
  ...
  const [formData, setFormData] = useState({ razon_social: "", ramoId: "" })
  ...
  const handleUpdateSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    console.log(selectedClient, "HOLAAAAAAAAAAA SOY EL SELECTEDCLIENT");
  ...
  const handleCreateSubmit = async (e: any) => {
    ...
    addClient(newClient)
    setFormData({ razon_social: "", ramoId: "" })
  };
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    console.log(name, value, "HOLAAAAAAAAAAA SOY EL INPUTCHANGE");
              ...
              <form onSubmit={handleUpdateSubmit}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="mt-1 p-2 border w-full rounded-lg text-gray-800"
                  />
                </div>
                <div className="mb-4">
