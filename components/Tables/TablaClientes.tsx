...
const ClientTable = () => {
  // Datos simulados
  const users = [
    { id: 1, name: "Lindsay Walton", apellido: "Front-end Developer", telefono: "lindsay.walton@example.com", ramo: "Member" },
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-gray-50">
              ...
              <th className="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">Apellido</th>
